      ...
      <section id="sub-mv" class="sub-mv">
        <div class="sub-mv__inner">
          <div class="sub-mv__img">
            <picture>
            <source
              srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/information-pc-sub-mv-img.jpg"
          ...
          <div class="page-information__container">
            <div class="page-information__content js-content is-active" id="info-tab1">
              <div class="page-information__content-wrap">
                ...
                <div class="page-information__img">
                  <img
                    src="<?php echo get_theme_file_uri(); ?>/assets/images/common/pc-page-information1.jpg"
            ...
            <div class="page-information__content js-content" id="info-tab2">
              <div class="page-information__content-wrap">
                ...
                <div class="page-information__img">
                  <img
                    src="<?php echo get_theme_file_uri(); ?>/assets/images/common/pc-page-information2.jpg"
                    alt="３匹のオレンジの魚が泳いでいる様子"
                  />
                </div>
              </div>
            ...
            <div class="page-information__content js-content" id="info-tab3">
              <div class="page-information__content-wrap">
                ...
                <div class="page-information__img">
                  <img
                    src="<?php echo get_theme_file_uri(); ?>/assets/images/common/pc-page-information3.jpg"
                    alt="３匹のオレンジの魚が泳いでいる様子"
                  />
                </div>
              </div>
