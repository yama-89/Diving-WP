...
<html lang="ja">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Gotu&family=Lato&family=Noto+Sans+JP:wght@400;500;700&family=Noto+Serif+JP:wght@400;500;700&display=swap"
      rel="stylesheet"
    />
    <!-- css -->
    <link
  ...
  <body>
    ...
    <main>
          ...
          <div class="mv__slider swiper js-mv-swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <picture>
                  <source
                    srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/pc-mv1.jpg"
              ...
              <div class="swiper-slide">
                <picture>
                  <source
                    srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/pc-mv2.jpg"
                    media="(min-width: 1024px)"
                  />
              ...
              <div class="swiper-slide mv__slide">
                <picture>
                  <source
                    srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/pc-mv3.jpg"
                    media="(min-width: 1024px)"
                  />
              ...
              <div class="swiper-slide">
                <picture>
                  <source
                    srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/pc-mv4.jpg"
                    media="(min-width: 1024px)"
                  />
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide campaign__card">
                <div class="card-campaign">
                  <div class="card-campaign__img">
                    <img
                      src="<?php echo get_theme_file_uri(); ?>/assets/images/common/campaign3.jpg"
                      alt="クラゲが泳いでいる様子"
                    />
                  </div>
                  <div class="card-campaign__body">
              ...
              <div class="swiper-slide">
                <div class="card-campaign">
                  <div class="card-campaign__img">
                    <img
                      src="<?php echo get_theme_file_uri(); ?>/assets/images/common/campaign4.jpg"
                      alt="ダイバーが海面で話している様子"
                    />
                  </div>
                  <div class="card-campaign__body">
            ...
            <div class="aboutus__img-box">
              <div class="aboutus__left-img">
                <picture>
                  ...
                  />
                  <img
                    src="assets/images/common/sp-aboutus1.jpg"
        ...
        <div class="infomation__inner inner">
          ...
          <div class="infomation__container">
            <div class="infomation__img js-colorbox">
              <img
                src="<?php echo get_theme_file_uri(); ?>/assets/images/common/sp-infomation.jpg"
                alt="３匹のオレンジの魚が泳いでいる様子"
              />
            </div>
          ...
          <div class="blog__cards blog-cards">
            <a href="#" class="blog-cards__card card-blog">
              <div class="card-blog__container">
                <div class="card-blog__img">
                  <img
                    src="<?php echo get_theme_file_uri(); ?>/assets/images/common/card-blog1.jpg"
                    alt="サンゴの様子"
                  />
                </div>
                <div class="card-blog__body">
                  <time class="card-blog__date" datetime="2023-11-17"
                    >2023.11/17</time
                  >
            ...
            <a href="#" class="blog-cards__card card-blog">
              <div class="card-blog__container">
                <div class="card-blog__img">
                  <img
                    src="<?php echo get_theme_file_uri(); ?>/assets/images/common/card-blog2.jpg"
                    alt="ウミガメが泳いでいる様子"
                  />
                </div>
                <div class="card-blog__body">
            ...
            <a href="#" class="blog-cards__card card-blog">
              <div class="card-blog__container">
                <div class="card-blog__img">
                  <img
                    src="<?php echo get_theme_file_uri(); ?>/assets/images/common/card-blog3.jpg"
                    alt="カクレクマノミの画像"
                  />
                </div>
                <div class="card-blog__body">
                ...
                <div class="card-voice__container">
                  <div class="card-voice__title-box">
                    ...
                    <div class="card-voice__img js-colorbox">
                      <img
                        src="<?php echo get_theme_file_uri(); ?>/assets/images/common/sp-card-voice1.jpg"
                        alt="女性の画像"
                      />
                    </div>
                  </div>
              ...
              <div class="voice-cards__card card-voice">
                <div class="card-voice__container">
                  <div class="card-voice__title-box">
                    ...
                    <div class="card-voice__img js-colorbox">
                      <img
                        src="<?php echo get_theme_file_uri(); ?>/assets/images/common/card-voice2.jpg"
                        alt="男性の画像"
                      />
                    </div>
                  </div>
          ...
          <div class="price__container">
            ...
            <div class="price__right-side">
              <div class="price__img js-colorbox">
                <picture>
                  <source
                    srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/pc-price.jpg"
                    media="(min-width: 768px)"
                    type="image/png"
                  />
                  <img
                    src="<?php echo get_theme_file_uri(); ?>/assets/images/common/sp-price.jpg"
                    alt="”複数の赤い魚が泳いでいる様子”"
                  />
                </picture>
              </div>
            ...
            <div class="contact__left">
              <div class="contact__logo-wrap">
                <div class="contact__logo">
                  <img
                    src="<?php echo get_theme_file_uri(); ?>/assets/images/common/sp-contact-logo.png"
                    alt="logo"
                  />
                </div>
              </div>
              <div class="contact__box">
                ...
                <div class="contact__map">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4937.814505861781!2d127.67657959485639!3d26.2131729976841!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x34e56bd6e046d289%3A0x345ffb669fadbd4f!2z6YKj6KaH5biC5b255omA!5e0!3m2!1sja!2sjp!4v1694611120782!5m2!1sja!2sjp"
                    width="600"
                    height="450"
                    style="border: 0"
                    allowfullscreen=""
      ...
      <div id="page-top" class="page-top js-page-top">
        <picture>
          <source
            srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/pc-pagetop.png"
            media="(min-width: 768px)"
            type="image/png"
          />
          <img
            src="<?php echo get_theme_file_uri(); ?>/assets/images/common/sp-pagetop.png"
            alt="トップへ戻るボタン"
          />
        </picture>
      </div>
